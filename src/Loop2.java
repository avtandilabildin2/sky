public class Loop2 {
    public static void main(String[] args) {
         ...
         *
         ...
         Исходная сумма всё та же — 15 тысяч рублей, проценты банка —
         7% ежемесячно.

         Напишите программу, которая будет выводить сумму накоплений
         за каждые полгода в течение 9 лет.
         */
        double startMoney=15000-(15000*0.07);
        double sum3=0;
        for (int i = 1; i <= 108; i++) {
            sum3+=startMoney;
            if(i%6==0){
                System.out.println("В полугодии "+i+" накоплено "+sum3+" рублей.");
            }
        }
        ...
        int dayOfWeek=5;
        while (dayOfWeek<=31){
            System.out.println("Сегодня пятница, " + dayOfWeek+"-е число.Необходимо" +
                    " подготовить отчет.");
            dayOfWeek+=7;
        }
        /**
